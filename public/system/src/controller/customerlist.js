...
layui.define(['table', 'form','setter'], function(exports){
    ...
    table.render({
        ...
        ,cols: [[
            ...
            ,{field: 'keywords_count', title: '已添词数',sort: true, align: 'center'}
            ,{field: 'compliance_rate', title: '达标率',sort: true, align: 'center',templet: function (d) {return d.compliance_rate ? d.compliance_rate+'%':0;}}
            ,{field: 'total_sum', title: '余额', sort: true, align: 'center'}
            ,{field: 'todaysum', title: '昨日消费', sort: true, align: 'center'}
    ...
    table.on('tool(LAY-app-customer-list)', function(obj){
        ...
        if(obj.event === 'editBalance'){
            ...
            window.open("http://"+window.location.host+"/customer/#/user/adminlogin")
            // alert(window.location.host);
            //window.open("http://www.100sucai.com/");
            // window.location.href = "http://"+window.location.host+"/customer/#/user/adminlogin";
