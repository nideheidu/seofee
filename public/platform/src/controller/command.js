        ...
        if(obj.event === 'orderinfo'){
            ...
            admin.popup({
                ...
                ,success: function(layero, index){
                    ...
                    view(this.id).render('simulation/command/add',data).done(function () {
                            vm.commands = JSON.parse(data.content);
                            vm.id = data.id;
                            vm.title = data.name;
                            vm.sort = data.sort;
                ...
                ,yes:function (index, layero) {
                    vm.commands.sort(function(a,b){
                        ...
                        admin.req({
                            ...
                            ,type:"post"
                            ,data:{"id":vm.id,"data":JSON.stringify(vm.commands),'title':vm.title,'sort':vm.sort}
                            ,done: function( res ){
                                layer.msg(res.msg, {
                                    offset: '15px'
                                    ,icon: 1
